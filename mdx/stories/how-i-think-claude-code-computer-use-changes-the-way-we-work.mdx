...
<Image
  src="claude-code-computer-use-cover.svg"
  alt="Cover image for Claude Code computer use story"
  layout="intrinsic"
  width={1200}
  height={630}
/>
...
<Image
  src="claude-code-computer-use-inline.svg"
  alt="Diagram comparing old workflow and agent workflow"
  layout="intrinsic"
  width={1200}
  height={720}
/>
